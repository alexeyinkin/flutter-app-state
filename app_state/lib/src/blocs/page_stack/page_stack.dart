...
class PPageStack<P extends PagePath> {
  ...
  void handleRemoved<R>(
    ...
    final state = pageBelow?.state;

    // ignore: deprecated_member_use_from_same_package
    if (state is CPageBloc<P, R>) {
      // ignore: deprecated_member_use_from_same_package
      state.onForegroundClosed(event);
    }
  }
...
@Deprecated('Renamed to PPageStack in v0.7.0')
typedef PageStackBloc = PPageStack<PagePath>;

@Deprecated('Renamed to PPageStack in v0.7.0')
typedef CPageStackBloc<P extends PagePath> = PPageStack<P>;
