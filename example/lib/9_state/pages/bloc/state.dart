...
class CounterBloc extends Bloc<CounterEvent, CounterBlocState> with PageStateMixin<void> {
  int _counter;

  CounterBloc({
    required int initialCount,
  }) : _counter = initialCount, super(CounterBlocState(counter: initialCount)) {
